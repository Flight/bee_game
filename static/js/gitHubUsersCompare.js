        ...
        _getUserRepositoriesListSortAndShow: function () {
            ...
            $.ajax({
                ...
                success: function (repositories) {
                    repositories.forEach(function (repository) { // => map
                    ...
                    repositoriesInfo = _.sortBy(repositoriesInfo, function (repositoryInfo) { // underscore property
        ...
        _getUserStarsCountAndCallback: function (userName, callback) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    data.forEach(function (repository) { // => reduce
...
/*
    1. Render template in one function.
    2. Deffered.
    3. We must check github API and internet connection at first.
    4. Add preloaders.
    5. Polymorph.
    6. Incapsulating.
*/